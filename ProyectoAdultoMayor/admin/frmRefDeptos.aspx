    ...
    <div class ="container">
        <% if (Request.QueryString["cmd"] == "edit")
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="/admin/frmRefDeptos.aspx">Gesti&oacute;n de Departamentos</a></li>
    ...
    <asp:ScriptReference Name="jquery"/>  
        ...
        <div class="panel panel-primary">
            ...
            <div class ="panel-body table-responsive">
                <p>
                    <a href="/admin/frmRefDeptos.aspx?cmd=add" class="btn btn-success">Agregar Departamento</a>
                </p>
